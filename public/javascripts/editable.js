...
var Editable = Class.create({
  ...
  setupForm: function() {
    ...
    this.editInput = new Element(this.editFieldTag, { 'name':('edit_' + this.element.identify()), 'id':('edit_' + this.element.identify()) });
  ...
  save: function(event) {
    ...
    new Ajax.Request(url, {
      ...
      onSuccess: function(transport) {
        ...
        var attr = this.element.identify().replace(/\w+\[(\w+)\]/, '$1');
